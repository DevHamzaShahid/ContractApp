...
export default class ChcekInvoice extends Component{
    ...
    async payInvoice(){
        ...
        try{
            ...
            if(responseJson.status == 'error'){
                ...
                this.props.navigation.navigate('InvoiceDetail',{invoice: responseJson.invoice, bankDetail: responseJson.bank_detail});
            }else{
            ...
            <View>
                ...
                <ScrollView>
                    <View style={{ alignItems:'center', marginTop: '2%', marginBottom: '8%' }}>
                        ...
                        <Text style={{ fontFamily: 'bold', fontSize: 22, marginTop: 10, color: '#000' }}>Chcek Invoice</Text>
                    </View>
                    <View>
                        <TitleInput
                            title={'Invoice #'}
