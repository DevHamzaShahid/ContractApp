...
class ContractForm extends Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            delivery:{
                ...
                whoPay: this.edit && this.preInvoice.pay_service_charges ? this.preInvoice.pay_service_charges : ''
            },
            imagePath:[]
    ...
    componentDidMount(){
        ...
        if(this.props.auth.user.bank_detail == ''){
            Alert.alert(
                'Error..',
                'Add Account detail to generate invoice.',[
                    ...
                    responseJson.msg,[
                      {text: 'OK', onPress: async () =>{
                        ...
                        let file = await RNHTMLtoPDF.convert(options);
                         ...
                         this.props.navigation.navigate('PdfView', {pdf_url: file.filePath})
                        this.setState({loading:false});
                      }
                    },
                    ], { cancelable: false }
